...
lin_connect_db <- function(options = NULL){
  ...
  if ((options_chr == "test") | (options_chr == "connect")) {
    source("~/Desktop/work/cofit/rd/00db_connection/connect_db_test.R")
    
    if ((connect_test == TRUE)) {
      print("[Successful connection!!]")
      if ((options_chr == "connect")) {
        source("~/Desktop/work/cofit/rd/00db_connection/connect_db.R")
      }
    }else{
  ...
  if (options_chr == "exit") {
    source("~/Desktop/work/cofit/rd/00db_connection/disconnect_db.R")
  }
